...
async def test_chat_agent_creation():
    ...
    agent = ChatAgent(
        agent_id="test_agent", name="Test Agent", description="Test description"
    )
...
def test_state_manager():
    ...
    state = manager.create_state(
        session_id="test_session", agent_id="test_agent", user_id="test_user"
    )
    assert state.session_id == "test_session"
    assert state.agent_id == "test_agent"

    # Add message
    manager.add_message("test_session", "user", "Test message")
