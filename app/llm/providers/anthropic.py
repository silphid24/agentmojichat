...
class AnthropicProvider(BaseLLMProvider):
    ...
    async def generate(
        ...
        **kwargs
        ...
        try:
            ...
            raise LLMError(f"Anthropic generation failed: {str(e)}", provider="anthropic")
    ...
    async def stream(
        ...
        **kwargs
        ...
        try:
            ...
            raise LLMError(f"Anthropic streaming failed: {str(e)}", provider="anthropic")
    ...
    def _format_messages(self, messages: List[BaseMessage]) -> tuple[List[Dict[str, str]], str]:
        ...
        if formatted and formatted[0]["role"] != "user":
            formatted.insert(0, {"role": "user", "content": "Continue the conversation"})
    ...
    def _parse_response(self, response_data: Dict[str, Any]) -> LLMResponse:
        ...
        try:
            ...
            raise LLMError(f"Invalid Anthropic response format: {e}", provider="anthropic")
