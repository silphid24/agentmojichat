...
class TeamsAdapter(BaseAdapter):
        ...
        if message.cards:
            ...
            for card in message.cards:
                hero_card = HeroCard(
                    ...
                    buttons=[
                        CardAction(
                            type=ActionTypes.open_url if btn.url else ActionTypes.im_back,
                            title=btn.text,
    ...
    async def _convert_attachments(self, teams_attachments: List[BotAttachment]) -> List[Attachment]:
    ...
    def _get_message_type(self, activity: Activity) -> MessageType:
        ...
        if activity.attachments:
            ...
            for att in activity.attachments:
                if att.content_type in ["application/vnd.microsoft.card.adaptive", 
