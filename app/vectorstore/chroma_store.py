...
class ChromaVectorStore(BaseVectorStore):
    ...
    async def delete(
        ...
        try:
            ...
            await self.persist()
            logger.info(f"Deleted documents from Chroma")
            return True
    ...
    async def get_collection_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "persist_directory": self.config.persist_directory,
                "distance_metric": metadata.get("distance_metric", self.config.distance_metric),
    ...
    async def hybrid_search(
        ...
        try:
            ...
            for result in vector_results:
                doc_id = result.document.metadata.get("chunk_id", hash(result.document.page_content))
